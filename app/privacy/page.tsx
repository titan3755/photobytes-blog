...
export const metadata: Metadata = {
  ...
  description: 'Read the privacy policy for PhotoBytes Studios to understand how we collect, use, and protect your personal information.',
};
      ...
      <div className={`bg-white min-h-screen w-screen ${atkinson_hyperlegible.className}`}>
        ...
        <section className="mb-12 text-lg">
          <p>
            ...
            , protecting the privacy of our visitors is one of our top priorities.
            This Privacy Policy explains the types of information collected and
            how it is used.
          </p>
          <p className="mt-4">
